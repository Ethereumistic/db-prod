...
const owners = [
    ...
    },
    {
        ...
        fullBio: "Дилян съчетава образование от Coventry University с опит в Нова телевизия като репортер на „Здравей, България“. Той е гласът на смисленото съдържание, фокусиран върху истории, които вдъхновяват и информират.",
        highlights: [
